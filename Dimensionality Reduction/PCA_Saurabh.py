...
#n_components is no. of principal component ie. no. features we want to keep which will explain max. variance
#First keep the n_components = None, after looking at the explained_variance_ratio_ we change it to desired value
#pca.explained_variance_ratio_ gives list of the principal components with explained variance ratio
#PCA extracted new independent variables are NOT the same independent variable which are in dataset
